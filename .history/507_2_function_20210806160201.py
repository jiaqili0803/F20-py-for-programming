...
###Function have scope
#1. Outer scope variables are valid within any inner scopes nested within the outer scope.
...
#3. If there is a name collision (variables in different scopes with the same name), the innermost scope wins.
