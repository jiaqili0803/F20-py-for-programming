#string functions: https://www.w3schools.com/python/python_strings_methods.asp


print("Welcome to the Activity Recommender!")
print("-" * 45)

#while loop method(multiple chances)
while True:
    temp_s = input("What is today's temperature (in F)? ") #is string
    #validate whether is num?
    if temp_s.isnumeric():  #str method, validate whether is num
        temp = int(temp_s)  #to int
        break  #break out of the while loop
    else:
        print("That's not a valid temperature. Better luck next time!")
