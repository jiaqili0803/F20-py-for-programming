class Dog: #class名称大写、驼峰大写
    ...
    def __init__(self, nm, br, a): #constructor，规定了objects都有一样的结构(self, nm, br, a)
        self.name = nm
        self.breed = br
        self.age = a
...
kennel = [              # instantiate objects from the classes you define 实例化
    Dog('Fido', 'German Shepherd', 4),    #list包含同样是Dog class同样结构的 几个东西
